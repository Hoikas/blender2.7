...
if(BUILD_MODE STREQUAL Release)
	if(WIN32)
		...
		ExternalProject_Add(external_zlib_32
			...
			CMAKE_GENERATOR_PLATFORM ${GENERATOR_PLATFORM_32}
		...
		ExternalProject_Add(external_zlib_64
			URL ${ZLIB_URI}
			CMAKE_GENERATOR ${GENERATOR}
			CMAKE_GENERATOR_PLATFORM ${GENERATOR_PLATFORM_64}
			URL_HASH SHA256=${ZLIB_HASH}
			DOWNLOAD_DIR ${DOWNLOAD_DIR}
		...
		ExternalProject_Add(external_blendthumb_32
			...
			CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/blendThumb32 ${DEFAULT_CMAKE_FLAGS} -DZLIB_INCLUDE=${LIBDIR}/zlib32/include -DZLIB_LIBS=${LIBDIR}/zlib32/lib/zs.lib
		...
		ExternalProject_Add(external_blendthumb_64
			...
			CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/blendThumb64 ${DEFAULT_CMAKE_FLAGS} -DZLIB_INCLUDE=${LIBDIR}/zlib64/include -DZLIB_LIBS=${LIBDIR}/zlib64/lib/zs.lib
