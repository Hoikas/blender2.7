...
if(NOT EXISTS "${DOWNLOAD_DIR}/i686-4.9.4-release-win32-sjlj-rt_v5-rev0.7z")
	...
	file(DOWNLOAD "https://master.dl.sourceforge.net/project/mingw-w64/Toolchains%20targetting%20Win32/Personal%20Builds/mingw-builds/4.9.4/threads-win32/sjlj/i686-4.9.4-release-win32-sjlj-rt_v5-rev0.7z?viasf=1" "${DOWNLOAD_DIR}/i686-4.9.4-release-win32-sjlj-rt_v5-rev0.7z")
endif()

# make mingw root directory
execute_process(
	COMMAND ${CMAKE_COMMAND} -E make_directory ${DOWNLOAD_DIR}/mingw/mingw32/bin
)
