...
ExternalProject_Add(external_zlib
	...
	# ZLIB 1.3 changed the library name in a way that causes chaos with the mingw build.
	# Change it back.
	PATCH_COMMAND ${PATCH_CMD} -p1 -N -d ${BUILD_DIR}/zlib/src/external_zlib < ${PATCH_DIR}/zlib_cmake.diff
	CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/zlib ${DEFAULT_CMAKE_FLAGS} ${ZLIB_EXTRA_ARGS}
