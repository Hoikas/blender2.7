...
set(PLATFORM_LINKFLAGS "${PLATFORM_LINKFLAGS} /NODEFAULTLIB:libcmt.lib /NODEFAULTLIB:libcmtd.lib")
set(PLATFORM_LINKFLAGS "${PLATFORM_LINKFLAGS} /NODEFAULTLIB:libcpmt.lib /NODEFAULTLIB:libcpmtd.lib")
...
set(PLATFORM_LINKFLAGS_DEBUG "${PLATFORM_LINKFLAGS_DEBUG} /IGNORE:4099 /NODEFAULTLIB:msvcrt.lib /NODEFAULTLIB:libc.lib")
...
if(WITH_BOOST)
	...
	if(NOT Boost_FOUND)
		...
		if(CMAKE_CL_64)
			set(BOOST_POSTFIX "vc${MSVC_TOOLSET_VERSION}-mt-x64-1_70.lib")
			set(BOOST_DEBUG_POSTFIX "vc${MSVC_TOOLSET_VERSION}-mt-gd-x64-1_70.lib")
		else()
			set(BOOST_POSTFIX "vc${MSVC_TOOLSET_VERSION}-mt-x32-1_70.lib")
			set(BOOST_DEBUG_POSTFIX "vc${MSVC_TOOLSET_VERSION}-mt-gd-x32-1_70.lib")
		endif()
		set(BOOST_LIBRARIES
...
if(WITH_OPENVDB)
	...
	set(OPENVDB_DEFINITIONS -DNOMINMAX -DHALF_EXPORTS -DOPENVDB_DLL)
endif()
